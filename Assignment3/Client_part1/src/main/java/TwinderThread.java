...
//        client.setBasePath("http://localhost:8080/Twinder_war_exploded/");
        ...
        try {
            for(int i = 0; i < 5000; i ++){
                ...
                while (swipeeGenerated.equals(swiperGenerated)) {
                    swiperGenerated = String.valueOf(ThreadLocalRandom.current().nextInt(1, 50001));
                    swipeeGenerated = String.valueOf(ThreadLocalRandom.current().nextInt(1, 50001));
                }
